...
<div class="container" style="max-width: 730px; margin-top: 10px;">
    <div class="header clearfix">
        <nav>
            <ul class="nav nav-pills pull-right">
                <li role="presentation"><a href="https://www.hackerrank.com/challenges/cube-summation">Ejercicio</a></li>
                <li role="presentation"><a href="https://github.com/goshmx/prueba-tecnica">@goshmx</a></li>

            </ul>
            <a class="btn btn-danger hide" id="reset-cube" href="#">Reiniciar cubo</a>
        </nav>
    ...
    <div class="jumbotron">
        ...
        <p align="right"><a class="btn btn-lg btn-success" id="btn-config-cubo" href="#" role="button">Configurar</a></p>
    </div>
                    ...
                    <div id="comando-insert">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-primary" id="btn-insert-command" type="button">Insertar!</button>
                            </span>
                        </div>
                    </div>
